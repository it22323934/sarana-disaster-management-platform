"""Alembic environment for alerting-svc.

Runs against the async engine and restricts autogenerate to the schemas this service
owns (alerting), so a migration here never proposes to drop another service's
...
import alerting_svc.repo  # noqa: F401
...
OWNED_SCHEMAS: set[str] = {"alerting"}
