"""Alembic environment for ledger-svc.

Runs against the async engine and restricts autogenerate to the schemas this service
owns (ledger), so a migration here never proposes to drop another service's
...
import ledger_svc.repo  # noqa: F401
