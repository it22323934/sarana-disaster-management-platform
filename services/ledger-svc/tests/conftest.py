"""Test configuration for ledger-svc."""
...
from ledger_svc.main import build_app
...
async def client(settings: Settings) -> AsyncIterator[AsyncClient]:
    ...
    async with (
        LifespanManager(app),
        AsyncClient(transport=ASGITransport(app=app), base_url="http://ledger-svc") as async_client,
    ):
        yield async_client
