"""Alembic environment for core-api.

Runs against the async engine and restricts autogenerate to the schemas this service
owns (reference, resilience), so a migration here never proposes to drop another service's
...
import core_api.repo  # noqa: F401
...
OWNED_SCHEMAS: set[str] = {"reference", "resilience"}
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema="reference",
