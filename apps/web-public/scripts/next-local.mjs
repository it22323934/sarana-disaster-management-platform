 ...
 *
 *   pnpm --filter @sarana/web-public build:local
 *   pnpm --filter @sarana/web-public start:local
 *
 ...
 * measure against a served production build: not the Lighthouse LCP assertion in file 21's
